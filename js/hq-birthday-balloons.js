(() => {
  const palettes = [
    ['#ff5f8f','#ff9f43','#ffd5df','linear-gradient(145deg,#fff,#ffb8d8 58%,#ff99c7)'],
    ['#4a8dff','#42d4ff','#d8f1ff','linear-gradient(145deg,#fff,#ffb8d8 58%,#ff99c7)'],
    ['#d64dff','#ff70cc','#f6d7ff','linear-gradient(145deg,#fff,#ffb8d8 58%,#ff99c7)'],
    ['#00d3a7','#6fff73','#d8ffe7','linear-gradient(145deg,#fff,#ffb8d8 58%,#ff99c7)'],
    ['#ffd548','#ff9a2f','#fff0be','linear-gradient(145deg,#fff,#ffb8d8 58%,#ff99c7)'],
    ['#8b6dff','#ff66d1','#eadbff','linear-gradient(145deg,#fff,#ffb8d8 58%,#ff99c7)'],
    ['#00c4ff','#00efd1','#d7fbff','linear-gradient(145deg,#fff,#ffb8d8 58%,#ff99c7)'],
    ['#ff6d6d','#ff4fa3','#ffe0ea','linear-gradient(145deg,#fff,#ffb8d8 58%,#ff99c7)']
  ];
  ...
  function ensureStyles() {
    ...
    style.textContent=`
      ...
      .birthday-card.hq-colour{border-color:rgba(217,0,119,.48);box-shadow:0 12px 28px rgba(73,79,111,.10)}
