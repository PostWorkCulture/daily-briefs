  ...
  function ensureBirthdayTab() {
    ...
    if (!document.getElementById('birthdayStyles')) {
      ...
      style.textContent = `
        ...
        .birthday-panel .section-head h2,.occasion-month h3{color:#fff!important}.birthday-list{display:grid;gap:30px}.occasion-month{display:grid;gap:14px}.occasion-month h3{margin:0 0 2px;font-size:15px}.birthday-month-grid{display:grid;grid-template-columns:1fr;gap:18px}
        ...
        @media(min-width:700px){.birthday-list{gap:36px}.birthday-month-grid{grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:22px}}
      `;
